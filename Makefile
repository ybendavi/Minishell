...
parsing/lexer.c parsing/parser_init.c parsing/token_list_init.c signal_init.c signal_errors.c ft_export.c ft_echo.c ft_unset.c\
parsing/handle_quote.c parsing/utils_2.c parsing/is_env.c parsing/parser.c parsing/utils.c exec/path_handler.c exec/builtin.c ft_cd.c ft_pwd.c
