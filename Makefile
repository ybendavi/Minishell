...
SRCSDIR = srcs
OBJSDIR = objs
SRCS = parsing/main.c parsing/libfunc.c parsing/libfunc_2.c exec/print_exec_error.c exec/miniparser.c exec/parser_assets.c exec/execution.c exec/freer.c exec/redir_parse.c exec/new_table.c exec/child_processes.c exec/exec_assets.c\
