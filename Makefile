...
parsing/lexer.c parsing/parser_init.c parsing/token_list_init.c signal_init.c signal_errors.c builtin/ft_export.c parsing/main.c\
...
builtin/ft_echo.c builtin/ft_unset.c parsing/count_lexer_token.c parsing/count_lexer_token_2.c parsing/count_parser_token.c builtin/ft_cd.c builtin/ft_pwd.c
