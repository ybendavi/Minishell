...
SRCSDIR = srcs
OBJSDIR = objs
SRCS = main.c utils/libfunc.c utils/libfunc_two.c exec/print_exec_error.c exec/miniparser.c exec/parser_assets.c exec/execution.c exec/freer.c exec/redir_parse.c exec/new_table.c exec/child_processes.c exec/exec_assets.c exec/path_handler_p2.c exec/exec_no_pipe.c\
...
parsing/handle_quote.c utils/utils_2.c parsing/is_env.c parsing/parser.c utils/utils.c exec/path_handler.c exec/builtin.c builtin/ft_cd.c\
...
parsing/handle_env.c parsing/is_env_2.c parsing/ft_return_2.c builtin/ft_unset_2.c exec/redir_parse_ex.c
